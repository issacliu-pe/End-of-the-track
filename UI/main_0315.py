    ...
    def build(self):
        ...
        rows: list = [
            Row(
                ...
                controls=[
                    ft.Image(
                        # src="https://picsum.photos/seed/picsum/200/300",  # Placeholder image URL
                        # src = "C:\Users\zcao\Documents\Spring24\TETT\TETUI01\wooden_cube.png"
                        # src=f"wooden_cube.png",
                        src=f"dark_backgroud_grid01.png", 
                        fit=ImageFit.NONE,
...
def main(page: ft.page):
    ...
    start_button = Container(
        content=ElevatedButton(
            ...
            content=Text("Start!", size=16, weight=FontWeight.BOLD),
            style=ButtonStyle(
                shape={"":RoundedRectangleBorder(radius=8)}, color={"": "black"},
            ),
            height=45,
            width=255,
        )
    ...
    page.add(
        Row(
            alignment=MainAxisAlignment.CENTER,
            controls=[
                Text("The End of The Track - Board Game",
                     size=36,
...
if __name__ == '__main__':
    ft.app(
        target=main,
        # assets_dir="C:\Users\zcao\Documents\Spring24\TETT\TETUI01"
